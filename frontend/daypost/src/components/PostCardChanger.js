  ...
  useEffect(() => {
    getPost({
      ...
      onSuccess: (body) => {
        ...
        setShowPost(body.posts.slice(0, 4));
      },
      onError: (error) => {
                ...
                {index === postNumber && (
                  <img
                    src={
                      slide.photo
                        ? `${slide.photo}`
                        : 'https://images.unsplash.com/photo-1481349518771-20055b2a7b24?ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8cmFuZG9tfGVufDB8fDB8fA%3D%3D&ixlib=rb-1.2.1&w=400&q=80'
                    }
                    alt='slideImg'
                  />
                )}
